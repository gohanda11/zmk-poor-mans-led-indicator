...
// RGB color definitions (adjusted for WS2812 color-mapping: G-R-B)
// Hardware mapping: LED_COLOR_ID_GREEN LED_COLOR_ID_RED LED_COLOR_ID_BLUE
// So RGB values should be: {Green, Red, Blue}
